package lpetlinski.pircclient.androidclient.mjpeg;
...
import lpetlinski.pircclient.androidclient.PiControllerActivity;
            ...
            while (mRun) {
                ...
                if (surfaceDone) {
                    try {
                        ...
                        if (ret == -1) {
                            ((PiControllerActivity) saved_context).mjpegImageError();
                            return;
                        }
